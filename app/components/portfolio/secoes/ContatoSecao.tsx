...
export function ContatoSecao({ estado }: ContatoSecaoProps) {
    return (
        <SecaoPortfolio id="s4" estado={estado} classeFundo="bg-[#0e0e0b]">
            <div className="relative z-2 w-[92%] max-w-165 px-2 text-center">
                ...
                <p className="mx-auto mt-5 mb-8 max-w-105 text-[12px] leading-7 font-light tracking-[0.02em] text-[#9b9386] sm:mt-7 sm:mb-11 sm:text-[13px] sm:leading-[1.9]">
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:justify-center sm:gap-3.5">
                    ...
                    <a
                        href="#"
                        className="border border-[#e8e0d0]/20 bg-transparent px-8 py-3.5 text-center text-[9px] font-medium tracking-[0.3em] text-[#d0c3ad] uppercase transition-colors duration-300 hover:border-[#d0c3ad] hover:text-[#e8e0d0] sm:px-9"
                    >
                        Ver LinkedIn
                    </a>
                </div>

                <div className="mt-8 break-all font-mono text-[10px] font-light tracking-[0.11em] text-[#9b9386] sm:mt-9 sm:text-[11px] sm:tracking-[0.12em]">
